...
function App() {
  ...
  const [fbSufccess, setFbSuccess] = useState(false);
  ...
  return (
      ...
      <section id="contact" className="py-5 dark-section">
        <div className="container d-flex flex-column align-items-center">
          ...
          >
            ...
            <form className="contact-form" onSubmit={handleFbSubmit}>
              <div className="mb-3">
                <label className="form-label accent-text">Your Name</label>
                 <input
      type="text"
      name="name"  className="form-control dark-input"
    ...
    />
              ...
              <div className="mb-3">
                ...
                <input
                  type="email"
                  name="email" className="form-control dark-input"
              ...
              <div className="mb-3">
                ...
                <textarea
                  name="message" className="form-control dark-input"
                  rows="4"
